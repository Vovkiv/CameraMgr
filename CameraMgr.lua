...
-- forked and edited by vovkiv (https://github.com/Vovkiv), (
local module = {}
...
function module.newManager()
  ...
  function camera.update(dt, w, h)
    ...
    camera.w = w or love.graphics.getWidth()
    camera.h = h or love.graphics.getHeight()
